(function() {
    ...
    window.CanvasSlideshow = function( options, resources ) {
      ...
      this.loadPixiSprites = function( sprites ) {
        ...
        for ( var i = 0; i < rSprites.length; i++ ) {
          ...
          let videoData = PIXI.loader.resources[vidname].data;
          var texture   = new PIXI.Texture.from( videoData );
          //var texture   = new PIXI.Texture.from(PIXI.loader.resources.vidname);
          ...
          var videoController = texture.baseTexture.source;
          

          videoController.setAttribute('loop', true);
          ...
          image.transform.scale.x = 1.1;
          image.transform.scale.y = 1.1;
     ...
     /*   const xgraphic = new PIXI.Graphics()
            .beginFill(0xffffff, 1)
            .drawRect(0, 0, 200, 200, 10)
            .endFill();
            */

        // Position the fade effect 
   //    xgraphic.x = (renderer.view.width - xgraphic.width) / 2;
     //  xgraphic.y = (renderer.view.height - xgraphic.height) / 2;

       
    //    stage.addChild(xgraphic);
      ...
      this.moveSlider = function( newIndex ) {
        ...
        .to(displacementFilter.scale, 1, { x: options.displaceScaleTo[0], y: options.displaceScaleTo[1], ease: Power2.easeOut }, 0.5 )
      ...
      this.init = function() {
        ...
        const button = new PIXI.Graphics()
            .beginFill(0x0, 0.5)
            .drawRoundedRect(0, 0, 1200, 1200, 10)
            .endFill()
            .beginFill(0xffffff)
            .moveTo(36, 30)
            .lineTo(36, 70)
        ...
        // Position the button
        button.x = (renderer.view.width - button.width) / 2;
        button.y = (renderer.view.height - button.height) / 2;
        ...
        function onPlayVideo() {
              ...
              */
                ...
                /*const texture2 = PIXI.Texture.from('../img/v2.mp4');

                // create a new Sprite using the video texture (yes it's that easy)
                const videoSprite = new PIXI.Sprite(texture2);
